...
//import {rootData} from "./firebaseConfig";
    ...
    firestore()
        ...
        .then(querySnapshot => {
            ...
            querySnapshot.forEach(documentSnapshot => {
                ...
                this.setState({dataFirebase:documentSnapshot.data()});
            });
        });
        /*.onSnapshot(querySnapshot => {
            ...
            querySnapshot.forEach(doc => {
                ...
                this.setState({dataFirebase:doc.data()});
            });
        }
    );*/
    //rootData.on('value', (dataSnapshot) => {
      //  this.setState({dataFirebase:dataSnapshot.val()})
    //})
  }
